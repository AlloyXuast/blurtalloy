...
var _cryptoSession = _interopRequireDefault(require("@steem/crypto-session"));
...
var _Dapps = require("./utils/Dapps");
var _NSFWPosts = _interopRequireDefault(require("./utils/NSFWPosts"));
...
if (env !== 'test') {
  ...
  app.nsfwPostsPromise = (0, _NSFWPosts["default"])();
  ...
  app.dappsPromise = (0, _Dapps.Dapps)();
