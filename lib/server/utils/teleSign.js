...
if (_config["default"].get('telesign.rest_api_key')) {
  api_key = Buffer.from(_config["default"].get('telesign.rest_api_key'), 'base64');
}
...
function verify(_ref) {
  ...
  return /*#__PURE__*/_regenerator["default"].mark(function _callee() {
    var result, _result$risk, recommendation, score, phone, sms, _yield$verifySms, reference_id;
