...
var _MuteButton = _interopRequireDefault(require("app/components/elements/MuteButton"));
var _FlagButton = _interopRequireDefault(require("app/components/elements/FlagButton"));
...
function TimeAuthorCategory(_ref) {
  var content = _ref.content,
    ...
    post_content = _ref.post_content,
...
function TimeAuthorCategoryLarge(_ref2) {
  var content = _ref2.content,
    ...
    post_content = _ref2.post_content;
  return /*#__PURE__*/_react["default"].createElement("span", {
  ...
  }), "\u2022\xA0", readingTime(content.body).text));
}
var PostFull = /*#__PURE__*/function (_React$Component) {
  ...
  function PostFull() {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "onTogglePin", function (isPinned) {
      var _this$props = _this.props,
        community = _this$props.community,
        username = _this$props.username,
        cont = _this$props.cont,
        post = _this$props.post;
      var content = cont.get(post);
      if (!community || !username) console.error('pin fail', _this.props);
      var key = ['content', post, 'stats', 'is_pinned'];
      _this.props.stateSet(key, !isPinned);
      var account = content.get('author');
      var permlink = content.get('permlink');
      _this.props.togglePinnedPost(!isPinned, username, community, account, permlink);
    });
    _this.state = {};
  ...
  (0, _createClass2["default"])(PostFull, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
        ...
        viewer_role = _this$props2.viewer_role,
      ...
      var authorMutedUsers = this.props.authorMutedUsers;
      ...
      if (process.env.BROWSER && title) {
        document.title = title + ' — ' + _client_config.APP_NAME;
      }
      ...
      var hideLinks = _BadActorList["default"].includes(content.author);
      var replyParams = {
        author: author,
        permlink: permlink,
      ...
      var total_payout = content.total_payout_value ? (0, _ParsersAndFormatters.parsePayoutAmount)(content.total_payout_value) : 0;
      if (content.author_payout_value && content.curator_payout_value) {
        total_payout = (0, _ParsersAndFormatters.parsePayoutAmount)(content.author_payout_value) + (0, _ParsersAndFormatters.parsePayoutAmount)(content.curator_payout_value);
      }
      ...
      var _isPaidout = post_content.get('payout_at') === '1969-12-31T23:59:59'; // TODO: audit after HF19. #1259
      var showReblog = !_isPaidout;
      var showPromote = false;
      // username && !_isPaidout && post_content.get('depth') == 0;
      var showReplyOption = username !== undefined && post_content.get('depth') < 255 && authorMutedUsers !== undefined && !authorMutedUsers.includes(username);
      var showReplyBlockedOption = username !== undefined && post_content.get('depth') < 255 && authorMutedUsers !== undefined && authorMutedUsers.includes(username);
      var showPinOption = post_content.get('depth') == 0 && _Community.Role.atLeast(viewer_role, 'mod');
      var showMuteOption = username && _Community.Role.atLeast(viewer_role, 'mod');
      ...
      var isPinned = post_content.getIn(['stats', 'is_pinned'], false);
      ...
      }, canFlag && /*#__PURE__*/_react["default"].createElement(_FlagButton["default"], {
        post: post_content
      ...
      }, "Reply Disabled"), showPinOption && /*#__PURE__*/_react["default"].createElement("a", {
        onClick: function onClick() {
          return _this3.onTogglePin(isPinned);
        }
      }, isPinned ? (0, _counterpart["default"])('g.unpin') : (0, _counterpart["default"])('g.pin')), showMuteOption && /*#__PURE__*/_react["default"].createElement(_MuteButton["default"], {
        post: post_content
      }), ' ', showEditOption && !showEdit && /*#__PURE__*/_react["default"].createElement("a", {
        onClick: onShowEdit
...
function (state, ownProps) {
  var post = ownProps.cont.get(ownProps.post);
