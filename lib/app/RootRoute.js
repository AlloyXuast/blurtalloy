...
var _App = _interopRequireDefault(require("app/components/App"));
var _Benchmark = _interopRequireDefault(require("app/components/pages/Benchmark"));
var _PostsIndex = _interopRequireDefault(require("app/components/pages/PostsIndex"));
var _ResolveRoute = _interopRequireDefault(require("./ResolveRoute"));
...
var _default = exports["default"] = {
  ...
  getChildRoutes: function getChildRoutes(nextState, cb) {
    var route = (0, _ResolveRoute["default"])(nextState.location.pathname);
    if (route.page === 'CommunityRoles') {
      ...
      // });
    } else if (route.page === 'Dapps') {
      // require.ensure([], (require) => {
      cb(null, [require('app/components/pages/Dapps')]);
      // });
  ...
  indexRoute: {
    component: _PostsIndex["default"].component
  }
};