...
exports.blurtApiError = exports.addNotification = exports.TOGGLE_NIGHTMODE = exports.TOGGLE_BLOGMODE = exports.SET_USER_PREFERENCES = exports.RECEIVE_FEATURE_FLAGS = void 0;
exports["default"] = reducer;
exports.toggleNightmode = exports.toggleBlogmode = exports.setUserPreferences = exports.selectors = exports.removeNotification = exports.receiveFeatureFlags = exports.fetchDataEnd = exports.fetchDataBegin = exports.defaultState = void 0;
...
function reducer() {
  ...
  switch (action.type) {
    ...
    case BLURT_API_ERROR:
      ...
      console.error('BlurtApiError', action.payload);
      return state;
...
var blurtApiError = exports.blurtApiError = function blurtApiError(error) {
  return {
