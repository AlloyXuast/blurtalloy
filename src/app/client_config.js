...
export const APP_URL = 'https://blurt.alloyxuast.co.uk/';
export const APP_DOMAIN = 'blurt.alloyxuast.tk';
...
export const LANDING_PAGE_URL = 'https://blurt.alloyxuast.co.uk/';
