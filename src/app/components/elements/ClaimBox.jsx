...
const getRewardsString = (account) => {
    const reward_blurt = parseFloat(account.get('reward_blurt_balance').split(' ')[0]) > 0 ? account.get('reward_blurt_balance') : null;
    // const reward_hbd = parseFloat(account.get('reward_hbd_balance').split(' ')[0]) > 0 ? account.get('reward_hbd_balance') : null;
    const reward_hp = parseFloat(account.get('reward_vesting_blurt').split(' ')[0]) > 0
