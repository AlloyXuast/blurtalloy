...
class CommunityPane extends Component {
    ...
    render() {
        ...
        const pending_rewards_dollar = community.get('sum_pending') * pricePerBlurt
            ...
            <div>
                <div className="c-sidebar__module">
                    ...
                    >
                        ...
                        <div className="column small-4">
                            {'$'}
                            {pending_rewards_dollar.toFixed(2)}
                            <br />
                            <small>
                                pending<br />rewards
                            </small>
                ...
                <div className="c-sidebar__module">
                    ...
                    <div>
                        ...
                        <br />
                        When publishing within the community, the community account will be automatically placed as the beneficiary of 3% of the publication.
                    </div>
                    <div>
