...
const ConnectedCommunitySubscriberList = connect(
    ...
    (state, ownProps) => {
        ...
        if (
            state.global.community.getIn([ownProps.community.name]) &&
            state.global.community.getIn([ownProps.community.name, 'subscribers']) &&
            state.global.community.getIn([ownProps.community.name, 'subscribers']).length > 0
        ) {
